...
public class CheckpointConfig implements java.io.Serializable {
    ...
    /**
     * The tolerable time range of checkpoint failures. If no checkpoint succeeds within this time range,
     * the job would be shut down. The default value is the max value of long.
     */
    ...
    public void setTolerableCheckpointFailuresTimeout(long tolerableCheckpointFailuresTimeout) {
        if (tolerableCheckpointFailuresTimeout < checkpointTimeout) {
            throw new IllegalArgumentException(
                    String.format("The tolerable continuous checkpoint failures timeout must be "
